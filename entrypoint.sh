...
ARG_MAPPING["-Rd"]="RING_DIR"
ARG_MAPPING["-Rs"]="RING_SIZE"
ARG_MAPPING["-Rm"]="RING_MAX_ID"
ARG_MAPPING["-Rp"]="RING_MAX_PACKET"
ARG_MAPPING["-NOMM"]="NO_MM"
ARG_MAPPING["-L"]="NETWORK_PORT"
ARG_MAPPING["-T"]="TRANSFER_LOG_DIR"
ARG_MAPPING["-Ti"]="TRANSFER_LOG_INTERVAL"
ARG_MAPPING["-Tp"]="TRANSFER_LOG_PREFIX"
ARG_MAPPING["-STDERR"]="STDERR"
ARG_MAPPING["-MSWRITE"]="MINISEED_WRITE"
ARG_MAPPING["-MSSCAN"]="MINISEED_SCAN"
